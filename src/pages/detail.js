          ...
          <div className="info-area">
            ...
            <div className="size-area v-c">
              {Sizes.map((item, index) => (
                <div
                  className={`size-container v-c ${
                    activeSize === index ? "active" : ""
                  }`}
                  key={index}
                  onClick={(e) => this.setState({ activeSize: index })}
                >
            ...
            <div className="btn-area v-r">
              <Button
                onClick={(e) =>
                  this.setState({ showRunway: !this.state.showRunway })
                }
              >
                {showRunway ? "Stop" : "Try On"}
              </Button>
